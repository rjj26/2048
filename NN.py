...
# "conv block"
conv2x2 = keras.layers.Conv2D(128, [2, 2], activation='relu', padding='same')(input)
conv3x3 = keras.layers.Conv2D(128, [3, 3], activation='relu', padding='same')(input)
...
model.fit( x_train, y_train, validation_data=(x_val, y_val), batch_size=250, epochs=500,
           verbose=1)
