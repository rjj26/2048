...
def load_cpp_data():
    with open("../sl_training_data/supervised_training.txt", "r") as f:
...
layer2 = keras.layers.Conv2D(500, [3, 3], activation='relu' )
layer3 = keras.layers.Conv2D(500, [2, 2], activation='relu' )
layer4 = keras.layers.Flatten()
#how many perceptrons are in this layer
layer5 = keras.layers.Dense( 512, activation='relu' )
layer6 = keras.layers.Dense( 128, activation='relu' )
...
model.save("Supervised_classification.keras")
